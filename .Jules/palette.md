...
## 2026-04-19 - Accessible Accordion Headers
**Learning:** Custom expandable components built with TouchableOpacity must explicitly include accessibilityRole="button", accessibilityState={{ expanded: boolean }}, and accessibilityLabel/Hint to correctly announce their toggle action and state to screen readers.
**Action:** Always add these props when building custom expand/collapse components.
