...
export default function LoginScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient
        colors={[modernColors.background.default, modernColors.background.paper]}
          ...
          <View style={styles.contentContainer}>
            ...
            >
              <View style={styles.iconContainer}>
                <Ionicons name="cube" size={56} color={modernColors.primary[400]} />
            ...
            {/* Login Form Card */}
            <Animated.View entering={FadeInUp.delay(400).springify()} style={styles.formContainerWrapper}>
              <GlassCard
                variant="strong"
                intensity={40}
                ...
                <View style={styles.form}>
                  <View style={styles.formHeader}>
                    ...
                    <Text style={styles.formSubtitle}>
                      {loginMode === "pin" ? "Use your 4-digit PIN to sign in" : "Sign in with your credentials"}
                    </Text>
                  </View>
                  ...
                  {loginMode === "pin" ? (
                    ...
                    >
                      {/* PIN Indicator Dots */}
                      <Animated.View style={[styles.pinIndicators, pinIndicatorStyle]}>
                        {[0, 1, 2, 3].map((index) => (
                          <View
                            key={index}
                            style={[
                        ...
                        <View style={styles.keypadRow}>
                          ...
                          >
                            <Ionicons
                              ...
                              size={24}
                              color={pin.length === 0 ? modernColors.text.tertiary : modernColors.text.primary}
                            />
                          </TouchableOpacity>
                        </View>
                      </View>
