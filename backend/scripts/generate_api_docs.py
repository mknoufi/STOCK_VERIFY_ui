...
All input data is validated using Pydantic models. Invalid data will return a 422 Unprocessable Entity error with validation details.
        ...
        servers=[
            ...
            {"url": "https://api.stockverify.example.com", "description": "Production server"},
        ],
    )
    ...
    openapi_schema["components"]["schemas"].update(
        {
            ...
            "VerificationCreate": {
                ...
                "properties": {
                    "item_id": {"type": "string", "description": "ID of the item being verified"},
                    "expected_count": {
                        "type": "integer",
                        "minimum": 0,
                    ...
                    "verification_method": {
                        "type": "string",
                        "enum": ["manual_count", "barcode_scan", "system_audit", "cycle_count"],
    ...
    openapi_schema["tags"] = [
        ...
        {"name": "Verification", "description": "Stock verification and discrepancy tracking"},
