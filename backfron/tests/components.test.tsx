...
describe("Item Management Components", () => {
  describe("ItemCard Component", () => {
    ...
    test("handles press events", () => {
      ...
      render(<MockItemCard item={mockItem} onPress={mockOnPress} />, {
        wrapper: TestWrapper,
      });
...
describe("Barcode Scanner Component", () => {
  ...
  test("renders scanner interface", () => {
    ...
    render(<MockBarcodeScanner onScanned={mockOnScanned} />, {
      wrapper: TestWrapper,
    });

    expect(screen.getByTestId("barcode-scanner")).toBeTruthy();
    expect(screen.getByTestId("scanner-status")).toHaveTextContent(
      "Ready to scan",
    );
  });
...
describe("Loading States", () => {
  ...
  test("shows content when not loading", () => {
    render(<MockLoadingComponent isLoading={false} data="test" />, {
      wrapper: TestWrapper,
    });
