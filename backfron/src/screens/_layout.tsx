...
export default function RootLayout() {
  ...
  // Using hooks to keep them engaged even if lint complains about unused exports from files
  // (We're importing them to ensure side effects or boostrapping but here we actually use them)
  const theme = useTheme();
  useSystemTheme();
  const segments = useSegments();
  const router = useRouter();
  // Use the bootstrap hook
