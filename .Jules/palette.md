...
## 2026-03-01 - Transient State Accessibility
...
**Action:** Always verify custom components with transient loading states expose `accessibilityState={busy: true}` and standard ARIA attributes.
