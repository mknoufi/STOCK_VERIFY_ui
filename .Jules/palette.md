...
## 2026-03-01 - Transient Icon Button State Accessibility
...
**Action:** Always add `accessibilityRole="button"`, `accessibilityLabel`, and explicitly map `loading` prop to both `disabled` and `busy` attributes within `accessibilityState`.
