  ...
  return (
    <View>
      ...
      <View style={styles.row}>
        <ModernCard variant="elevated" title="Session Status Distribution" icon="pie-chart" style={styles.chartCard}>
        ...
        <ModernCard variant="elevated" title="Top Users by Activity" icon="people" style={styles.chartCard}>
      ...
      <View style={styles.row}>
        <ModernCard variant="elevated" title="Variance Trend" icon="trending-up" style={styles.chartCard}>
        ...
        <ModernCard variant="elevated" title="Staff Performance" icon="people" style={styles.chartCard}>
