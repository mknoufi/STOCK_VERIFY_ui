        ...
        <View style={styles.centered}>
          <GlassCard variant="medium" padding={auroraTheme.spacing.xl}>
            <View style={{ alignItems: 'center', gap: auroraTheme.spacing.md }}>
              <Ionicons name="alert-circle-outline" size={48} color={auroraTheme.colors.text.tertiary} />
              <Text style={{ color: auroraTheme.colors.text.secondary }}>Item not found</Text>
              <AnimatedPressable onPress={() => router.back()}>
                <Text style={{ color: auroraTheme.colors.primary[500] }}>Go Back</Text>
              </AnimatedPressable>
            </View>
          </GlassCard>
        </View>
      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <Animated.View entering={FadeInDown.delay(200).springify()}>
            <GlassCard variant="light" padding={auroraTheme.spacing.lg} borderRadius={auroraTheme.borderRadius.lg} style={styles.card}>
              <View style={styles.itemHeader}>
                <View style={styles.itemIcon}>
                  <Ionicons name="cube-outline" size={32} color={auroraTheme.colors.primary[400]} />
                </View>
                <View style={{ flex: 1 }}>
          ...
          <Animated.View entering={FadeInDown.delay(400).springify()}>
            <GlassCard variant="medium" padding={auroraTheme.spacing.lg} borderRadius={auroraTheme.borderRadius.lg} style={styles.card}>
              <View style={styles.detailRow}>
                <View style={styles.detailItem}>
                  <Text style={styles.detailLabel}>Verified By</Text>
                  <View style={styles.detailValueRow}>
                    <Ionicons name="person-circle-outline" size={18} color={auroraTheme.colors.text.secondary} />
                ...
                <View style={styles.detailItem}>
                  ...
                  <View style={styles.detailValueRow}>
                    <Ionicons name="time-outline" size={18} color={auroraTheme.colors.text.secondary} />
                    <Text style={styles.detailValue}>
                      {itemDetails.verified_at ? new Date(itemDetails.verified_at).toLocaleString() : 'N/A'}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              {(itemDetails.floor || itemDetails.rack) && (
                <View style={[styles.detailRow, { marginTop: auroraTheme.spacing.md }]}>
                  <View style={styles.detailItem}>
                    <Text style={styles.detailLabel}>Location</Text>
                    <View style={styles.detailValueRow}>
                      <Ionicons name="location-outline" size={18} color={auroraTheme.colors.text.secondary} />
                      <Text style={styles.detailValue}>
        ...
        <Animated.View entering={FadeInDown.delay(500).springify()} style={styles.footer}>
          <GlassCard variant="dark" padding={auroraTheme.spacing.md} style={styles.footerInner}>
