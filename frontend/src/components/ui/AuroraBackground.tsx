...
export const AuroraBackground: React.FC<AuroraBackgroundProps> = ({
  ...
  return (
    <View style={[styles.container, style]}>
      ...
      <LinearGradient
        colors={[auroraTheme.colors.background.primary, auroraTheme.colors.background.secondary]}
        style={StyleSheet.absoluteFill}
      />

      {/* Animated gradient blobs */}
      <Animated.View style={[styles.blob, styles.blob1, blob1Style, { opacity }]}>
        <LinearGradient
      ...
      <Animated.View style={[styles.blob, styles.blob2, blob2Style, { opacity }]}>
        <LinearGradient
      ...
      <Animated.View style={[styles.blob, styles.blob3, blob3Style, { opacity }]}>
        <LinearGradient
