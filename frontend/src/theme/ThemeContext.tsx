...
export type PatternType = 'none' | 'dots' | 'grid' | 'waves' | 'aurora' | 'mesh' | 'circuit' | 'hexagon';
...
const THEME_METADATA: { key: ThemeKey; name: string; preview: string[] }[] = [
  ...
  { key: 'premium', name: 'Aurora Pro', preview: ['#030712', '#6366F1', '#8B5CF6'] },
  { key: 'ocean', name: 'Ocean', preview: ['#042F2E', '#14B8A6', '#0EA5E9'] },
  { key: 'sunset', name: 'Sunset', preview: ['#1C1917', '#F97316', '#E11D48'] },
  { key: 'highContrast', name: 'High Contrast', preview: ['#000000', '#00D4FF', '#00FF88'] },
];
...
// Layout metadata
const LAYOUT_METADATA: { key: LayoutArrangement; name: string; icon: string }[] = [
...
export const ThemeProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const theme = useMemo(() => themes[effectiveThemeKey] || themes.premium, [effectiveThemeKey]);
