    ...
    >
      ...
      <View style={[styles.summary, { backgroundColor: surfaceDark }]}>
        ...
        <View style={styles.summaryRow}>
          ...
          <Text
            style={[styles.summaryValue, { color: "#4CAF50", marginLeft: 4 }]}
          >
            {summary.passed}
          </Text>
        </View>
        <View style={styles.summaryRow}>
          ...
          <Text
            style={[styles.summaryValue, { color: "#f44336", marginLeft: 4 }]}
          >
            {summary.failed}
          </Text>
        </View>
        <View style={styles.summaryRow}>
          ...
          <Text
            style={[styles.summaryValue, { color: "#FFB74D", marginLeft: 4 }]}
          >
            {summary.warnings}
          </Text>
        </View>
              ...
              >
                ...
                {step.details && (
                  <View style={styles.detailsContainer}>
                    <Text
                      style={[styles.detailsText, { color: tertiaryTextColor }]}
                    >
                      {Platform.OS === "web"
