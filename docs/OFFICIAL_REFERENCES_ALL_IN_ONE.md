...
This file consolidates the **authoritative** external references for this repo into one place.

Source of truth: `docs/REFERENCES.md` (governance rule: only the links listed there are authoritative).
