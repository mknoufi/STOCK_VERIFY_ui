...
export const ScanGuideOverlay: React.FC<ScanGuideOverlayProps> = ({
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={[styles.row, { height: scanRegion.height }]}>
          ...
          >
            ...
            <Animated.View style={[styles.cornerContainer, cornerStyle]}>
              {/* Top-left */}
              <View style={[styles.corner, styles.cornerTopLeft, { width: cornerSize, height: cornerSize }]}>
                <View style={[styles.cornerLine, styles.cornerLineHorizontal, { height: cornerThickness }]} />
                <View style={[styles.cornerLine, styles.cornerLineVertical, { width: cornerThickness }]} />
              </View>

              {/* Top-right */}
              <View style={[styles.corner, styles.cornerTopRight, { width: cornerSize, height: cornerSize }]}>
                <View style={[styles.cornerLine, styles.cornerLineHorizontal, { height: cornerThickness }]} />
                <View style={[styles.cornerLine, styles.cornerLineVertical, { width: cornerThickness }]} />
              </View>

              {/* Bottom-left */}
              <View style={[styles.corner, styles.cornerBottomLeft, { width: cornerSize, height: cornerSize }]}>
                <View style={[styles.cornerLine, styles.cornerLineHorizontal, { height: cornerThickness }]} />
                <View style={[styles.cornerLine, styles.cornerLineVertical, { width: cornerThickness }]} />
              </View>

              {/* Bottom-right */}
              <View style={[styles.corner, styles.cornerBottomRight, { width: cornerSize, height: cornerSize }]}>
                <View style={[styles.cornerLine, styles.cornerLineHorizontal, { height: cornerThickness }]} />
                <View style={[styles.cornerLine, styles.cornerLineVertical, { width: cornerThickness }]} />
              </View>
            </Animated.View>
      ...
      {/* Message */}
      <View style={[styles.messageContainer, { top: scanRegion.y + scanRegion.height + spacing.lg }]}>
