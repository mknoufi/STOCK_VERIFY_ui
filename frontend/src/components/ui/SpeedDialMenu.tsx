...
export const SpeedDialMenu: React.FC<SpeedDialMenuProps> = ({
  ...
  const getPositionStyles = () => {
    ...
    switch (position) {
      case "bottom-right":
        return { ...base, bottom: auroraTheme.spacing.lg, right: auroraTheme.spacing.lg };
      case "bottom-left":
        return { ...base, bottom: auroraTheme.spacing.lg, left: auroraTheme.spacing.lg };
      case "top-right":
        return { ...base, top: auroraTheme.spacing.lg, right: auroraTheme.spacing.lg };
      case "top-left":
        return { ...base, top: auroraTheme.spacing.lg, left: auroraTheme.spacing.lg };
    }
  };
