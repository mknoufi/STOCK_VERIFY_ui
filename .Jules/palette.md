...
## 2024-11-20 - Transient State Icon Button Accessibility
...
**Action:** Always add dynamic `accessibilityLabel` (e.g., "Refresh"), `accessibilityRole="button"`, and `accessibilityState` to icon-only action buttons.
