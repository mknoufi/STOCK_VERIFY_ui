                      ...
                      <View style={styles.sessionCardContent}>
                        ...
                        <View style={styles.sessionInfo}>
                          ...
                          <Text style={[styles.sessionMeta, { color: theme.colors.textSecondary }]}>
                            {session.item_count || session.total_items || 0} items • {new Date(session.created_at || session.started_at).toLocaleDateString()}
                          </Text>
                        </View>
                    ...
                    <View style={[styles.finishedSessionCard, { backgroundColor: isDark ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.02)', borderColor: theme.colors.border }]}>
                      <View style={styles.sessionCardContent}>
                        ...
                        <View style={styles.sessionInfo}>
                          ...
                          <Text style={[styles.sessionMeta, { color: theme.colors.textSecondary }]}>
                            {session.item_count || session.total_items || 0} items • Last used {getRelativeTime(session.closed_at || session.updated_at || session.created_at)}
                          </Text>
                        </View>
                      </View>
                    </View>
