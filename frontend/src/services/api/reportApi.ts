...
export const reportApi = {
  ...
  generateReportUrl: async (params: GenerateReportParams): Promise<string> => {
    const response = await api.post<{ download_url: string; expires_in: number }>(
...
export async function downloadReport(params: GenerateReportParams, filename?: string): Promise<void> {
