...
import type { SpeedDialAction, ActivityType } from "../../src/components/ui";
      ...
      <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
        ...
        {loading && !refreshing ? (
          <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
            <Ionicons name="cube-outline" size={48} color={theme.colors.accent} style={{ marginBottom: 16 }} />
              ...
              >
                <View style={styles.progressContent}>
                  ...
                  <ProgressRing
                    ...
                    size={100}
                    strokeWidth={10}
                    colors={[auroraTheme.colors.success[500], auroraTheme.colors.success[700]]}
                  />
                </View>
              </GlassCard>
            </Animated.View>
                              ...
                              backgroundColor:
                                session.status === "OPEN"
                                  ...
                                  : session.status === "CLOSED"
                                    ...
                                    : auroraTheme.colors.secondary[500],
                            },
                          ]}
                        >
                          <Text
