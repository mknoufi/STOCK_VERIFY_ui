...
const STATUS_CONFIG: Record<StatusType, { color: string; icon: keyof typeof MaterialCommunityIcons.glyphMap }> = {
...
function MetricRow({ label, value, unit, warning }: { label: string; value: number | string; unit?: string; warning?: boolean }) {
  return (
    ...
    return (
      <View style={styles.container}>
        <View style={styles.header}>
          <MaterialCommunityIcons name="server" size={20} color={auroraTheme.colors.primary[500]} />
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          <MaterialCommunityIcons name="alert-circle" size={24} color={auroraTheme.colors.error[500]} />
    ...
    <View style={styles.container}>
      ...
      {(isHighLatency || isHighErrorRate || isHighMemory || isHighCPU) && (
        <View style={styles.warningBanner}>
          <MaterialCommunityIcons name="alert" size={16} color={auroraTheme.colors.warning[500]} />
