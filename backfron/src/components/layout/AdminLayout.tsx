...
export const AdminLayout: React.FC<AdminLayoutProps> = ({
  ...
  const isMobile = width < breakpoints.md; // Use md breakpoint for tablet/mobile split
...
const styles = StyleSheet.create({
  ...
  drawerOverlay: {
    ...
    right: 0,
    bottom: 0,
    zIndex: modernLayout.zIndex.modalBackdrop,
  },
  drawerBackdrop: {
    flex: 1,
  ...
  drawer: {
    ...
    top: 0,
    bottom: 0,
    width: modernLayout.sidebarWidth,
    zIndex: modernLayout.zIndex.modal,
