...
## 2024-07-22 - Button Loading State Focus
**Learning:** In React Native, returning a completely separate loading component inside a button removes it from the accessibility tree, breaking focus. Also, swapping components can cause layout jumps.
